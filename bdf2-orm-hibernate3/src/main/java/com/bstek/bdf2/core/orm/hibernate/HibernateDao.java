...
public abstract class HibernateDao extends AbstractDao implements ApplicationContextAware {
	 ...
	 * 
	 * @param page
	 *            包含pageNo与pageSize值的dorado7 page对象
	 * @param queryString
	 *            查询目标结果用的HQL
	 ...
	 *             可能抛出的异常
	 */
	public void pagingQuery(Page<?> page, String queryString, String countQueryString, String dataSourceName)
			throws Exception {
	 ...
	 *            查询目标结果用的HQL
	 * @param parameters
	 *            查询中可能包含的查询条件值,按位置顺序拼装参数方式
	 * @param parametersMap
	 *            查询中可能包含的查询条件值,按参数名拼装参数方式，与参数parameters只能二选一
	 * @param dataSourceName要采用的目标数据源名称
	 * @throws Exception
	 *             可能抛出的异常
	 */
	protected void pagingQuery(final Page<?> page, final String queryString, final String countQueryString,
			final Object[] parameters, final Map<String, Object> parametersMap, String dataSourceName) throws Exception {
	...
	public void pagingQuery(Page<?> page, String queryString, String countQueryString, Map<String, Object> parametersMap)
			throws Exception {
