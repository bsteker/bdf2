...
public class DbInfoConfig {
	private static final String FILE_PATH = com.bstek.bdf2.core.context.ContextHolder.getBdfTempFileStorePath();
	private static final String FILE_NAME = "bdf2-dbconsole.xml";
