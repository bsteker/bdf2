...
public class SplitPanelSupport extends AbstractSupport {
	private Collection<ISupport> children;
	public String getDisplayName() {
		return SplitPanel.class.getSimpleName();
	}

	public String getFullClassName() {
		return SplitPanel.class.getName();
	}

	public String getIcon() {
		return "com/bstek/bdf2/rapido/icons/SplitPanel.gif";
	}
