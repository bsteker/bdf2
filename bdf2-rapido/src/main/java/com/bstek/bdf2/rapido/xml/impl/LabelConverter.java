...
public class LabelConverter extends AbstractConverter {

	public Element convert(ComponentInfo component, RuleSet ruleSet,
			Element rootElement) throws Exception {
		String name=Label.class.getSimpleName();
		XmlNode node=Label.class.getAnnotation(XmlNode.class);
	...
	public boolean support(ComponentInfo component) {
		return Label.class.getName().equals(component.getClassName());
	}
}
