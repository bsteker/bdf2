...
public class ListDropDownConverter extends AbstractConverter {

	public Element convert(ComponentInfo component, RuleSet ruleSet,
			Element rootElement) throws Exception {
		String name=ListDropDown.class.getSimpleName();
		XmlNode node=ListDropDown.class.getAnnotation(XmlNode.class);
	...
	public boolean support(ComponentInfo component) {
		return ListDropDown.class.getName().equals(component.getClassName());
	}
