...
public class RowSelectorColumnConverter extends AbstractConverter{
	...
	public Element convert(ComponentInfo component, RuleSet ruleSet,
		...
		String name=RowSelectorColumn.class.getSimpleName();
		XmlNode node=RowSelectorColumn.class.getAnnotation(XmlNode.class);
	...
	public boolean support(ComponentInfo component) {
		return component.getClassName().equals(RowSelectorColumn.class.getName());
	}
