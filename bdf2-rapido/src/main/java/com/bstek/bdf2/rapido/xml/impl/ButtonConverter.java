...
public class ButtonConverter extends AbstractConverter{
	...
	public Element convert(ComponentInfo component, RuleSet ruleSet,Element rootElement) throws Exception {
		String name=Button.class.getSimpleName();
		XmlNode node=Button.class.getAnnotation(XmlNode.class);
	...
	public boolean support(ComponentInfo component) {
		return component.getClassName().equals(Button.class.getName());
	}
}
