...
public class TextAreaConverter extends AbstractConverter {

	public Element convert(ComponentInfo component, RuleSet ruleSet,
			Element rootElement) throws Exception {
		String name=TextArea.class.getSimpleName();
		XmlNode node=TextArea.class.getAnnotation(XmlNode.class);
	...
	public boolean support(ComponentInfo component) {
		return TextArea.class.getName().equals(component.getClassName());
	}
}
