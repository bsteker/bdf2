...
public class BindingConfigsConverter extends AbstractConverter {

	public Element convert(ComponentInfo component, RuleSet ruleSet,
			Element rootElement) throws Exception {
		Element element=new BaseElement("BindingConfigs");
	...
	public boolean support(ComponentInfo component) {
		return "BindingConfigs".equals(component.getClassName());
	}
}
