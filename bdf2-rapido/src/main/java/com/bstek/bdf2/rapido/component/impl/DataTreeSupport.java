...
public class DataTreeSupport extends AbstractSupport {
	private Collection<ISupport> children;
	public String getDisplayName() {
		return DataTree.class.getSimpleName();
	}

	public String getFullClassName() {
		return DataTree.class.getName();
	}

	public String getIcon() {
		return "com/bstek/bdf2/rapido/icons/DataTree.gif";
	}
