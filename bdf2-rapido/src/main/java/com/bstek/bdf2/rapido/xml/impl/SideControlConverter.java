...
public class SideControlConverter extends AbstractConverter {

	public Element convert(ComponentInfo component, RuleSet ruleSet,
			Element rootElement) throws Exception {
		BaseElement element = new BaseElement("SideControl");		
	...
	public boolean support(ComponentInfo component) {
		return "SideControl".equals(component.getClassName());
	}
