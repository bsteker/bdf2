...
public class TriggerConverter extends AbstractConverter {

	public Element convert(ComponentInfo component, RuleSet ruleSet,
			Element rootElement) throws Exception {
		String name=Trigger.class.getSimpleName();
		XmlNode node=Trigger.class.getAnnotation(XmlNode.class);
	...
	public boolean support(ComponentInfo component) {
		return Trigger.class.getName().equals(component.getClassName());
	}
}
