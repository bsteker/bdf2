...
public class CheckBoxConverter extends AbstractConverter {

	public Element convert(ComponentInfo component, RuleSet ruleSet,
			Element rootElement) throws Exception {
		String name=CheckBox.class.getSimpleName();
		XmlNode node=CheckBox.class.getAnnotation(XmlNode.class);
	...
	public boolean support(ComponentInfo component) {
		return component.getClassName().equals(CheckBox.class.getName());
	}
}
