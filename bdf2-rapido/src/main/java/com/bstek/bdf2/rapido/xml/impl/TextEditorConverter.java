...
public class TextEditorConverter extends AbstractConverter {

	public Element convert(ComponentInfo component, RuleSet ruleSet,
			Element rootElement) throws Exception {
		String name=TextEditor.class.getSimpleName();
		XmlNode node=TextEditor.class.getAnnotation(XmlNode.class);
	...
	public boolean support(ComponentInfo component) {
		return TextEditor.class.getName().equals(component.getClassName());
	}
}
