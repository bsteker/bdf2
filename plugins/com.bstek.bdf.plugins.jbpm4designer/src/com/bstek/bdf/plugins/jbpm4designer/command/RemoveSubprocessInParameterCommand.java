 ...
 * @author Jacky
 */
public class RemoveSubprocessInParameterCommand extends AbstractSubprocessParameterCommand {
	private SubprocessParameter targetSubprocessParameter;
	public RemoveSubprocessInParameterCommand(SubprocessParameter targetSubprocessParameter,SubprocessNode node){
		this.node=node;
		this.targetSubprocessParameter=targetSubprocessParameter;
	}
	@Override
	public void execute() {
		this.node.removeInParameter(targetSubprocessParameter);
	}
}
