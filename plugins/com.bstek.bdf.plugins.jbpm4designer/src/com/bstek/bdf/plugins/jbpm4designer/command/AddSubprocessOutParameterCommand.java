 ...
 * @author Jacky
 */
public class AddSubprocessOutParameterCommand extends AbstractSubprocessParameterCommand {
	private SubprocessParameter newSubprocessParameter;
	public AddSubprocessOutParameterCommand(SubprocessParameter newSubprocessParameter,SubprocessNode node){
		this.node=node;
		this.newSubprocessParameter=newSubprocessParameter;
	}
	@Override
	public void execute() {
		this.node.addOutParameter(newSubprocessParameter);
	}
}
